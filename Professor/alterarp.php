...
{
    // Lógica de criptografia usando a função hash
    // Aqui estou usando a função sha256 como exemplo, mas você pode usar outras como sha1, sha512, etc.
    return hash('sha256', $cpf);
}

function criptografarSenha($senha)
{
    // Lógica de criptografia para a senha
    // Aqui, usando a função password_hash para criar um hash bcrypt seguro
        ...
        if(!empty($_GET['id'])) {
            ...
            if($result->num_rows > 0){  
                ...
                while($user_data = mysqli_fetch_assoc($result)){
                    ...
                    $nome = $user_data["nome"];
                    $cpf = criptografarCPF($user_data["cpf"]);
                    ...
                    $senha = criptografarSenha($user_data['senha']);
                    $confirmar_senha =  criptografarSenha($user_data['senha']);
                    }
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="alterarp1.css">
</head>
<body>
    <div id="Titulo">
    ...
    <div class="">
    <a href="sistemap.php" class="btn-voltar">voltar</a>
    </div>
    <div class="Cadastro">
        <div class="card-header">
            <form action="salvaedp.php" method="POST">
                <h2>Informe quais dados você quer alterar</h2>
                <div class="card-content-area">
                
                <label for="nome">Nome:</label>
                    <input type="text" id="nome" placeholder="nome" name="nome" class="input" value="<?php echo $nome?>" required />
                </div>
                ...
                <div class="card-content-area">
                    ...
                    <input type="date" id="date" name="datan" min="1850-01-01" required class="input" value="<?php echo $datan?>"/>
                </div>
                <div class="card-content-area">
